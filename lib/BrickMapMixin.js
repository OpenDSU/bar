...
const BrickMapMixin = {
     ...
     */
    hasItems: function () {
        return Object.keys(this.header.items).length > 0 || Object.keys(this.header.embedded).length > 0;
    },
    ...
    getEmbeddedFile: function (filePath) {
        ...
        if (this.header.embedded) {
            data = this.header.embedded[filePath];
        }
    ...
    putEmbeddedFile:  function (filePath, data) {
        ...
        this.header.embedded[filePath] = data;
    },
